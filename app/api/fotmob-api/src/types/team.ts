...
const typeMap: any = {
	...
	Details: o(
		[
			...
			{ json: "faqJSONLD", js: "faqJSONLD", typ: r("FAQJSONLD") },
			{
				...
				js: "sportsTeamJSONLD",
				typ: r("SportsTeamJSONLD"),
			},
			{
				json: "breadcrumbJSONLD",
				js: "breadcrumbJSONLD",
				typ: r("BreadcrumbJSONLD"),
			},
	...
	Current: o([{ json: "link", js: "link", typ: a(r("Link")) }], false),
	Link: o(
		[
			{ json: "_", js: "_", typ: "" },
	...
	TeamFormAway: o([{ json: "isOurTeam", js: "isOurTeam", typ: true }], false),
	DateClass: o([{ json: "utcTime", js: "utcTime", typ: Date }], false),
	TooltipText: o(
		[
			{ json: "utcTime", js: "utcTime", typ: Date },
	...
	ContractExtension: o(
		[
			...
			{ json: "transferDate", js: "transferDate", typ: Date },
			{
				json: "transferText",
				js: "transferText",
				typ: a(u(r("ShortNameEnum"), 0, null)),
			},
	...
	Country: ["ENG", "INT"],
	ShortNameEnum: ["Liverpool"],
	CoachType: ["Person"],
	NationalityType: ["Country"],
	AddressCountry: ["England", "Europe", "World"],
	NameElement: [
		"Champions League",
		"Club Friendlies",
		"EFL Cup",
	...
	Color: ["#FF4646", "#FFD908", "#0046A7", "#2AD572"],
	TKey: [
		"championsleague",
		"europaleague",
