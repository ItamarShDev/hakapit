...
const typeMap: any = {
	...
	BenchEvents: o([{ json: "sub", js: "sub", typ: r("Sub") }], false),
	Sub: o(
		[
		...
		[
			{
				json: "Minutes played",
				js: "Minutes played",
				typ: u(undefined, u(r("AerialsLost"), 0)),
			},
			...
			},
			{
				json: "Shot accuracy",
				js: "Shot accuracy",
				typ: u(undefined, r("ShotAccuracy")),
			},
			{
				json: "Shot off target",
				js: "Shot off target",
				typ: u(undefined, r("AerialsLost")),
			},
			{
			...
			{
				json: "Dribbles attempted",
				js: "Dribbles attempted",
				typ: u(undefined, u(r("AerialsLost"), 0)),
			},
			{
				json: "Dribbles succeeded",
				js: "Dribbles succeeded",
				typ: u(undefined, u(r("AerialsLost"), 0)),
			},
			{
				json: "Dispossessed",
			...
			{
				json: "Tackles attempted",
				js: "Tackles attempted",
				typ: u(undefined, u(r("AerialsLost"), 0)),
			},
			{
				json: "Tackles succeeded",
				js: "Tackles succeeded",
				typ: u(undefined, u(r("AerialsLost"), 0)),
			},
			{
				json: "Aerials won",
	...
	Odds: o([{ json: "show", js: "show", typ: true }], false),
	PlayerOfTheMatch: o(
		[
			{ json: "id", js: "id", typ: 0 },
			{ json: "name", js: "name", typ: "" },
	...
	SEO: o([{ json: "path", js: "path", typ: "" }], false),
	TeamNameElement: ["Manchester City", "Wolverhampton Wanderers"],
	Long: ["Full-Time"],
	Short: ["FT"],
	Bgcolor: ["#ffa726", "#0e87e0", "#6ecb5b", "#989898"],
	Role: ["Attacker", "Defender", "Keeper", "Midfielder"],
	AerialsLost: ["-", "100%", "50%", "79%"],
	ShotAccuracy: ["0%", "100%", "33%", "50%"],
	Highlighted: ["away", "equal", "home"],
	Type: ["graph", "text"],
};
