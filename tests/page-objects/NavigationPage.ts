...
export class NavigationPage {
  ...
  // Navigation elements
  get homeLink() {
    return this.page.getByRole('link', { name: 'בית' });
  }

  get hakapitLink() {
    return this.page.getByRole('link', { name: 'הכפית' });
  }

  get nitkLink() {
    return this.page.getByRole('link', { name: 'שכונה בממלכה' });
  }

  get balconyAlbumsLink() {
    return this.page.getByRole('link', { name: 'אלבומים במרפסת' });
  }

  get logoLink() {
    return this.page.getByRole('link', { name: 'הכפית' }).locator('..');
  }
